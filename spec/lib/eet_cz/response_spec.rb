  ...
  def success_xml
    <<~HEREDOC
      <?xml version="1.0" encoding="UTF-8"?>
        <soapenv:Envelope
          xmlns:eet="http://fs.mfcr.cz/eet/schema/v3" xmlns:ds="http://www.w3.org/2000/09/xmldsig#"
          xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"
          xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd"
          xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/"
          xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
          <soapenv:Header>
            <wsse:Security soapenv:mustUnderstand="1">
              <wsse:BinarySecurityToken
                wsu:Id="SecurityToken-65b228bd-513e-4dcd-912e-fc5d42b1dde7"
                ...
                DgwNTU0NTJaMIGeMQswCQYDVQQGEwJDWjEzMDEGA1UEAwwqRWxla3Ryb25pY2vDoSBldmlkZW5jZS
              </wsse:BinarySecurityToken>
              <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
                ...
                <SignatureValue>
                  N3xjla0JvW7GJGdHUecEQHYPas7LTV29IPKVV2CIVBXGcW42iqiheL3UNhwMpKxjCTDIz/jf+NzzKC2eJTPqgPeIQYb7tGkJ5
                  ...
                  lVxOECR6qPJ9gfOgPrOCz0opDprZ8bYPKbKFjsvwMCLAxZOD2vxdKM/lOs57gSrshfNPdldKMieZCyBSXWwuQz4SqoRALOm/yv4gVAHznl21+t9Hg==
                </SignatureValue>
                <KeyInfo>
                  <wsse:SecurityTokenReference xmlns="">
                  <wsse:Reference
                    URI="#SecurityToken-65b228bd-513e-4dcd-912e-fc5d42b1dde7"
                    ValueType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0#X509v3"/>
          ...
          <soapenv:Body wsu:Id="Body-50bc2dc7-441a-4013-9f39-70f437f5408a">
            <eet:Odpoved>
              <eet:Hlavicka
                uuid_zpravy="3d2e888f-25a9-462f-9f1d-554fe7e9551d"
                bkp="3F9119C1-FBF34535-D30B60F8-9859E4A6-C8C8AAFA"
                dat_prij="2016-12-19T12:14:02+01:00"/>
              <eet:Potvrzeni
                fik="fbfef3cf-ab44-4e5b-b1f5-16eccc2d9485-ff"
                test="true"/>
            </eet:Odpoved>
          </soapenv:Body>
        </soapenv:Envelope>
